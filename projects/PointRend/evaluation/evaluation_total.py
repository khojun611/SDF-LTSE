...
cfg.MODEL.WEIGHTS = "/home/user/text_inr/pointrend2/pointrend/projects/PointRend/output_gt_total_text/model_0009999.pth"
predictor = DefaultPredictor(cfg)

image_path = "/home/user/text_inr/detectron2/projects/PointRend/datasets/total_text_segmentation/Test"
image_list = natsort.natsorted(os.listdir(image_path))

sdf_path = "/home/user/text_inr/detectron2/projects/PointRend/datasets/total_text_segmentation/seg_test3"
...
for i,d in enumerate(image_list):
    ...
    # textseg
    # png.save("/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/gt_total_text/{}.png".format(d["file_name"][-10:].strip(".jpg")))
    png.save("/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/total_inr/{}.png".format(image_list[i][:-4]))
...
def evaluate_iou_and_average(input_folder, target_folder):
    ...
    for input_img_name in input_images:
        ...
        target_img_name = input_img_name.split('.')[0] + '_mask.jpg'
...
# 사용 예
input_folder = "/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/total_inr"  # 입력 이미지가 저장된 폴더 경로
target_folder = "/home/user/text_inr/detectron2/projects/PointRend/datasets/total_text_segmentation/test_gt"
  # 대상 이미지가 저장된 폴더 경로
