...
cfg.MODEL.WEIGHTS = "/home/user/text_inr/pointrend2/pointrend/projects/PointRend/output/model_0039999.pth"
...
for i,d in enumerate(image_list):
    ...
    png.save("/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/api/{}.png".format(image_list[i][:-4]))
