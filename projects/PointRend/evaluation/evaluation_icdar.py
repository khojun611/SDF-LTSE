...
cfg.MODEL.WEIGHTS = "/home/user/text_inr/pointrend2/pointrend/projects/PointRend/output_icdar2/model_0004999.pth"
predictor = DefaultPredictor(cfg)

image_path = "/home/user/text_inr/detectron2/projects/PointRend/datasets/ICDAR13/ICDAR_test"
image_list = natsort.natsorted(os.listdir(image_path))

sdf_path = "/home/user/text_inr/detectron2/projects/PointRend/datasets/ICDAR13/ICDAR_seg_test"
...
for i,d in enumerate(image_list):
    ...
    png.save("/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/ICDAR_inr/{}.png".format(image_list[i][:-4]))
...
def evaluate_iou_and_average(input_folder, target_folder):
    ...
    for input_img_name in input_images:
        ...
        target_img_name = 'gt_' + input_img_name.split('.')[0] + '.png'
...
# 사용 예
input_folder = "/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/ICDAR_inr"  # 입력 이미지가 저장된 폴더 경로
target_folder = "/home/user/text_inr/detectron2/projects/PointRend/datasets/ICDAR13/ICDAR_seg_test_255"
  # 대상 이미지가 저장된 폴더 경로
