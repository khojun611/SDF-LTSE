...
sdf_path = "/home/user/text_inr/detectron2/projects/PointRend/datasets/textseg/seg_test3"
...
for i,d in enumerate(image_list):
    ...
    png.save("/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/concat/{}.png".format(image_list[i][:-4]))
