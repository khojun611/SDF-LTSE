...
sdf_path = "//home/user/text_inr/MetaSparseINR/data/test_down_res"
sdf_list = natsort.natsorted(os.listdir(sdf_path))

mask_path = "/home/user/text_inr/detectron2/projects/PointRend/datasets/textseg/seg_test3"
...
for i,d in enumerate(image_list):
    ...
    png.save("/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/gt_minus_sdf/{}.png".format(image_list[i][:-4]))
...
# 사용 예
input_folder = "/home/user/text_inr/pointrend2/pointrend/projects/PointRend/new_quantitative/gt_minus_sdf"  # 입력 이미지가 저장된 폴더 경로
